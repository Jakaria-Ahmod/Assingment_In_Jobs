  ...
  return (
    <div className="group">
      <div className="h-[526px] rounded overflow-hidden relative">
        ...
        <div className="bg-orange-700 cursor-pointer absolute bottom-0 left-0 w-full flex justify-between px-[10px] py-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
